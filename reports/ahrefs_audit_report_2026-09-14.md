...
**Gepruefte Seiten:** 405 (2 Fehler, 104 Warnungen, 93 Hinweise)
...
| Warning | Meta description too long | Content | 8 | unveraendert |
| Warning | Slow server response for AI crawlers | AI Discoverability | 2 | (neu erfasst) |
| Warning | Meta description tag missing or empty | Content | 1 | unveraendert |
| Warning | Noindex page | Indexability | 1 | unveraendert |
| Notice | Structured data has Google rich results validation error | Other | 78 | unveraendert |
